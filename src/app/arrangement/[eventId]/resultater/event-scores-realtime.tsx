  ...
  return (
    <div className={styles.scoresContainer}>
      {sortedWineScores.map((wine, index) => (
        <div key={wine.product_id} className={styles.wineScoreCard}>
          ...
          <div className={styles.wineScoreContent}>
            <div className={styles.wineScoreHeader}>
              <h3 className={styles.wineScoreName}>{wine.name}</h3>
            ...
            {wine.count > 0 ? (
              <>
                ...
                <div className={styles.detailedScores}>
                  <ScoreBar label="Farge" value={wine.avgFarge} max={10} />
                  <ScoreBar label="Lukt" value={wine.avgLukt} max={20} />
                  <ScoreBar label="Smak" value={wine.avgSmak} max={20} />
                  <ScoreBar label="Friskhet" value={wine.avgFriskhet} max={10} />
                  <ScoreBar label="Fylde" value={wine.avgFylde} max={10} />
                  <ScoreBar label="Sødme" value={wine.avgSodme} max={10} />
                  <ScoreBar label="Snærp" value={wine.avgSnaerp} max={10} />
