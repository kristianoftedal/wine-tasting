    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
      ...
      <div className="">
        ...
        <p>
          ...
          vinentusiast, hjelper vi deg med å utforske, vurdere og forstå vin på
          en enkel og morsom måte.{" "}
        </p>
        <p>
        ...
        <p>
          📔 Din digitale smakdagbok Lag notater, gi karakterer og bygg din egen
          samling av favorittviner. Perfekt for å huske hvilke viner du elsker!
          🔍 Lær mer om druer og regioner Få innsikt i forskjellige druesorter,
