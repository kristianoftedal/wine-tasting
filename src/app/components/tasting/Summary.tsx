    ...
    async function calculateScores() {
      ...
      try {
        ...
        console.log("[v0] Wine data:", {
          ...
          mainCategory: wine?.main_category?.code,
        })
        console.log("[v0] User data:", {
          ...
          snaerp: tastingState.snaerp,
          sodme: tastingState.sodme,
        })
        ...
        console.log("[v0] Snærp score:", snærpScore, "user:", tastingState.snaerp, "vmp:", vmpSnærp)

        const sødmeScore = calculateNumericSimilarity(tastingState.sodme, vmpSødme)
        console.log("[v0] Sødme score:", sødmeScore, "user:", tastingState.sodme, "vmp:", vmpSødme)
          ...
          <div className={styles.comparisonTable}>
            ...
            {isRedWine && (
              <div className={styles.tableRow}>
                ...
                <div className={styles.scoreValue}>{scores.snaerp}%</div>
              </div>
            )}
            ...
            {!isRedWine && (
              <div className={styles.tableRow}>
                ...
                <div className={styles.scoreValue}>{scores.sodme}%</div>
              </div>
            )}
