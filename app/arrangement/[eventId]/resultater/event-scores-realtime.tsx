              ...
              <div className={styles.tabsContainer}>
                <div className={styles.tabsList}>
                  {[
                    ...
                    <button
                      key={tab.id}
                      className={`${styles.tabButton} ${getActiveTab(wine.id) === tab.id ? styles.tabButtonActive : ""}`}
      ...
      <div className={styles.participantsAccordion}>
        {sortedTastings.map((tasting, index) => {
          ...
          return (
            <div
              key={tasting.id}
              className={`${styles.participantAccordionItem} ${expandedParticipant === tasting.id ? styles.participantAccordionItemExpanded : ""}`}
            >
              <button
              ...
              >
                ...
                <div className={styles.participantInfo}>
                  ...
                  <div className={styles.participantScoreBar}>
                    <div className={styles.participantScoreBarFill} style={{ width: `${percentage}%` }} />
                  </div>
                </div>
                ...
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth="2"
                  className={`${styles.participantChevron} ${expandedParticipant === tasting.id ? styles.chevronRotated : ""}`}
                >
                  <path d="M6 9l6 6 6-6" />
                </svg>
              </button>
