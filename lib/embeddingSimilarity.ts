 ...
 */
export async function embeddingSimilarity(text1: string, text2: string): Promise<number> {
 ...
 */
export async function batchEmbeddingSimilarity(
  ...
  try {
    ...
    console.error("Batch embedding similarity error:", error)
    return pairs.map(() => 0)
  }
}
